M = {
    ...
    on_attach = function(client, bufnr)
        ...
        set_keymap('n', '<C-s>', vim.lsp.buf.signature_help, bufopts)
        set_keymap('n', 'gT', vim.lsp.buf.type_definition, bufopts)
        set_keymap('n', '<space>rn', vim.lsp.buf.rename, bufopts)
        set_keymap('n', '<space>ca', vim.lsp.buf.code_action, bufopts)
        ...
        -- set_keymap('n', '<space>q', vim.diagnostic.set_loclist, opts)
        -- set_keymap("n", "<space>f", vim.lsp.buf.formatting, bufopts)
